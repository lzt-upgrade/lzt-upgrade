...
const getContestsItems = async () => {
  ...
  return [
    new Container(
      [
        new Checkbox('hide_tags_in_contests', `Скрыть теги в теме розыгрыша`)
        .createElement(
        ...
        new Checkbox('remove_content_in_contests', `Скрыть содержимое темы розыгрыша`)
        .createElement(
        ...
        new Checkbox('remove_poll_in_contests', `Скрыть голосование в теме розыгрыша`)
        .createElement(
