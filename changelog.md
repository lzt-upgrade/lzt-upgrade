## 1.1.0
Обновление до этой версии является обязательным, все остальные версии, теперь, сломаны из-за изменений в работе IndexedDB. Откат возможен, только, при размещение файлов предыдущей версии на стороннем файлообменнике.
