...
- Добавлено предупреждение о том, что за использование "Открыть прогруженные розыгрыши" вы можете получить временную блокировку розыгрышей
...
- Все ожидания элемента через "sleep" заменены на "WaitForElement", теперь, мы ждем сам элемент, а не просто ожидаем не понятно что
