...
- Добавление кнопки быстрого открытия N количества розыгрышей
- Дальше больше :)
...
## Примечание:
Используя скрипт вы соглашаетесь с тем, что скрипт может отслеживать нажатие ваших клавиш на форуме (не сохраняет их)
